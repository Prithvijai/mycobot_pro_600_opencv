...
import glob  # Used to retrieve files that have a specified pattern
...
def main():
    # Get the file path for images in the specified directory
    images = glob.glob('/home/kris/mycobot_pro_600_ws/src/aruco_ros/scripts/images/*.png')
